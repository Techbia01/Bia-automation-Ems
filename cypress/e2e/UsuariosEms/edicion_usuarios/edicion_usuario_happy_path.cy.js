// cypress/e2e/UsuariosEms/edicion_usuarios/edicion_usuario_happy_path.cy.js
import LoginPage from '../../../pages/LoginPage.js';
import CreacionUsuarioEmsPage from '../../../pages/creacion_usuarios/creacion_usuario_ems/CreacionUsuarioEmsPage.js';

describe('Edición de Usuario y Cambio de Rol - Happy Path', () => {
  let loginPage;
  ...
  it('Debería editar datos del usuario y cambiar el rol a Contabilidad', () => {
    ...
    // Generar valores únicos para la edición (nombres reales)
    const timestamp = Date.now();
    // Lista de nombres reales para rotar y hacer únicos
    ...
    const nuevoNombre = nombresReales[indiceNombre];
    const nuevoApellido = apellidosReales[indiceApellido];
